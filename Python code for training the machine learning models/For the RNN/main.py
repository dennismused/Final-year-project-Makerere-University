...
metadata = pd.read_csv('E:/Users/DENNIS/PycharmProjects/pythonProject/FYP_Project_RNN/Prepared beehive dataset/metadata.csv')
print(metadata.head())
...
extracted_features_df.to_pickle('E:/Users/DENNIS/PycharmProjects/pythonProject/FYP_Project_RNN/Prepared beehive dataset/Normalised_features_RNN.pkl')


# Loading the created dataframe of the extracted features for use
extracted_features_df = pd.read_pickle('E:/Users/DENNIS/PycharmProjects/pythonProject/FYP_Project_RNN/Prepared beehive dataset/Normalised_features_RNN.pkl')
...
# first layer - RNN layer with 16 units
model.add(SimpleRNN(16,input_shape=(40,1), return_sequences=True))
model.add(Activation('relu'))
model.add(Dropout(0.5))
# second layer - RNN layer with 32 units
...
checkpointer = ModelCheckpoint(filepath='E:/Users/DENNIS/PycharmProjects/pythonProject/FYP_Project_RNN/Trained RNN model/Normalised_FYP_Beehivemodel_RNN.hdf5', verbose=1, save_best_only=True)
start = datetime.now()
...
model = load_model('Trained RNN model/FYP_Beehivemodel_RNN.hdf5')
